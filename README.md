...
GitHub/Git, VS Code, React, Boostrap

### Key Features <a name="key-features"></a>

- Home page with brief introduction of Max Driving School
...
Clone this repository to your desired folder in your laptop:
  ...
  cd "your-folder-name"
  git clone git@github.com:https://github.com/mpa-mxiang/drive-web.git
...
We would like to thank Max, my driving coach to provide us this opportunity to do such a real-life project.
